...
public class Add extends JFrame implements ActionListener {
	...
	JButton add,Back;
	JTextField tfname,tfaddress,tfphone,tfdhar,tfsalary,tffname,tfemail,tfdesignation,tfdob;
...
add(lblid);
	...
	public void actionPerformed(ActionEvent a) {
		...
		if(a.getSource()==add) {
			...
			try {
				DB conn=new DB();
				String query="insert into employee1 values('"+name+"', '"+fname+"','"+dob+"', '"+salary+"','"+address+"','"+phone+"','"+email+"','"+education+"','"+designation+"','"+aadhar+"','"+bloodgroup+"','"+gender+"','"+empid+"')";
